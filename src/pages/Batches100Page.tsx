...
export default function Batches100Page() {
  useEffect(() => {
    ...
    const runLogic = () => {
      ...
      //
      // 2. For PRODUCTION, you must add a backend endpoint that:
      //    a) Creates a Razorpay Order before checkout opens (server-side)
      //    b) Verifies the payment signature after success (server-side)
      //    c) Saves registration data to your database / CRM
      //
      //    Look for "// PRODUCTION:" comments below where backend
      ...
      form.addEventListener('submit', async (e) => {
        ...
        // =====================================================
        // PRODUCTION: Replace this block with a backend call
        // -----------------------------------------------------
        ...
        //     currency: 'INR',
        //     notes: { fullName, phone, email, city, category }
        //   })
        // });
        // const order = await orderResponse.json();
        // // Use order.id in the options below as: order_id: order.id
        // =====================================================
        ...
        const options = {
          ...
          // order_id: order.id,  // PRODUCTION: Uncomment and use server-generated order ID
          ...
          handler: function (response) {
            // Payment successful
            // ===================================================
            // PRODUCTION: Send response to backend for signature
            // verification before treating payment as confirmed
            // -----------------------------------------------
            ...
            //     registration: { fullName, phone, email, city, category }
            //   })
            // });
            // ===================================================
            ...
            form.reset();
            document.querySelector('input[name="category"][value="Small"]').checked = true;
...
<section class="moments">
  <div class="container">
    <div class="section-header centered">
      ...
      <h2 class="section-title">Moments from our <em>Batches.</em></h2>
      <p class="section-lead">Real photos from our training campus and graduation ceremonies.</p>
    </div>

    <div class="moments-grid">
      <div class="moment-item">
        <img src="/batch-1.jpg" alt="Drone Academy Workshop" />
      </div>
      <div class="moment-item">
        <img src="/batch-2.jpg" alt="Students in Classroom" />
      </div>
      <div class="moment-item">
        <img src="/batch-3.jpg" alt="Batch Photo" />
      </div>
      <div class="moment-item">
        <img src="/batch-4.jpg" alt="Outdoor Training" />
      </div>
      <div class="moment-item">
        <img src="/batch-5.jpg" alt="Certification Ceremony" />
      </div>
      <div class="moment-item">
        <img src="/batch-6.jpg" alt="Drone Academy Event" />
      </div>
      <div class="moment-item">
        <img src="/batch-7.jpg" alt="Student Training" />
      </div>
      <div class="moment-item">
        <img src="/batch-8.jpg" alt="Workshop Session" />
      </div>
    </div>
  </div>
</section>
